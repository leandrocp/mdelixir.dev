...
function createCard(t) {
  ...
  card.rel = "noopener";
  card.className =
    "testimonial-card group block p-6 border border-dashed border-stone-300 dark:border-stone-700 bg-stone-50 dark:bg-stone-900 hover:border-brand hover:bg-white dark:hover:bg-stone-800 transition-all duration-300 relative";
  card.innerHTML = `
